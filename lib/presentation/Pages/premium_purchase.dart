            ...
            children: [
              ...
              Positioned(
                top: screenSize.height *
                    0.35, // Overlap slightly with the image for a smooth transition
                left: 0,
                right: 0,
                bottom: 0,
                child: Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        ...
                        const Color(
                            0xFF1A1A2E), // Dark color similar to the screenshot
                      ],
                      stops: const [
                        0.0,
                        0.4
                      ], // Adjust stop to control gradient fade
                    ),
                    color: const Color(
                        0xFF15212F), // Solid dark color for the lower part
                  ),
                ),
              ),
              // Content Overlay
                          ...
                          children: [
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: Color(
                                      0xFF253743), // Semi-transparent white
                            ...
                            const SizedBox(
                                width:
                                    40), // To balance the row with the back button
                          ],
                        ),
                      ),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: Color(0xFF1E3347)
                                .withOpacity(0.4), // Slightly transparent dark
                      ...
                      GestureDetector(
                        ...
                        child: Text(
                          ...
                          style: GoogleFonts.nunitoSans(
                            ...
                            decorationColor:
                                const Color(0xFFF5C253), // Yellow underline
                            decorationThickness: 2,
                          ),
                        ),
                      ),
                      SizedBox(
                          height: screenSize.height * 0.04), // Bottom padding
                    ],
                  ),
                ),
              ),
